...
export const Navbar = () => {
  ...
  return (
    <div className="flex sticky justify-between items-center h-20 text-gray-100 bg-offwhite dark:bg-black dark:shadow-md dark:shadow-black dark:text-offwhite">
      <img
